...
public class LoginStartActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            updateUI(user);
                            HashMap<String, String> userMap = clearDB();
                            NextActivity(userMap);
                        } else {
    ...
    private HashMap<String, String> clearDB(){
        // 현재 로그인한 사용자 정보 가져오기
        FirebaseUser currentUser = mAuth.getCurrentUser();
        if (currentUser != null) {
            // 사용자 정보 출력
            ...
            Log.w("User Info", "No authenticated user found.");
            return null;
        }
    }

    private void NextActivity(HashMap<String, String> userInfo) {
        Intent intent = new Intent(LoginStartActivity.this, FaceIdActivity.class);
